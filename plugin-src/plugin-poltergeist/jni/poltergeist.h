...
/// Turn a device on
void on_off_turn_on(Client* client, char const* device, uint8_t endpoint);

/// Turn a device off
void on_off_turn_off(Client* client, char const* device, uint8_t endpoint);

/// Toggle a device's on/off status
void on_off_toggle(Client* client, char const* device, uint8_t endpoint);
