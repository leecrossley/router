...
var _default = function _default(context) {
  ...
  if (context.hook === 'after_platform_add' && context.cmdLine.includes('platform add') || context.hook === 'after_prepare' && context.cmdLine.includes('prepare') || context.hook === 'after_plugin_add' && context.cmdLine.includes('plugin add')) {
    platformMetadata.getPlatformVersions(projectRoot).then(function (platformVersions) {
      ...
      bridgingHeaderContent = ['//', '//  Use this file to import your target\'s public headers that you would like to expose to Swift.', '//', '#import <Cordova/CDV.h>', '#import "consumer_client.h"'];
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(getConfigParser, 'getConfigParser', '/Users/lee/presciense/iot/app/plugin-src/plugin-swift/src/main.js');

  __REACT_HOT_LOADER__.register(getBridgingHeaderPath, 'getBridgingHeaderPath', '/Users/lee/presciense/iot/app/plugin-src/plugin-swift/src/main.js');

  __REACT_HOT_LOADER__.register(_default, 'default', '/Users/lee/presciense/iot/app/plugin-src/plugin-swift/src/main.js');
}();
